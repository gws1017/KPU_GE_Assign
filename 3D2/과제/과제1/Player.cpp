...
// CAirplanePlayer
//
CAirplanePlayer::CAirplanePlayer(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, ID3D12RootSignature *pd3dGraphicsRootSignature, void *pContext, int nMeshes)
	: CPlayer(nMeshes) // CPlayer(pd3dDevice, pd3dCommandList, pd3dGraphicsRootSignature, pContext, nMeshes)
{
	...
	nMeshes) : CPlayer(nMeshes)
{
	...
	SetPosition(XMFLOAT3(pTerrain->GetWidth() * 0.5f, fHeight + 500.0f, pTerrain->GetLength() * 0.5f)); //플레이어 초기 위치설정
...
CCamera* CTerrainPlayer::ChangeCamera(DWORD nNewCameraMode, float fTimeElapsed)
{
	...
	case FIRST_PERSON_CAMERA:
		...
		SetGravity(XMFLOAT3(0.0f, gravity, 0.0f)); 
