...
D3D12_RASTERIZER_DESC CShader::CreateRasterizerState()
{
	...
	d3dRasterizerDesc.FillMode = D3D12_FILL_MODE_SOLID;	// WIREFRAME - 변, SOLID - 면
	d3dRasterizerDesc.CullMode = D3D12_CULL_MODE_BACK;	// BACK, FRONT - 은면 제거 on, NONE - 은면 제거 off
...
D3D12_DEPTH_STENCIL_DESC CShader::CreateDepthStencilState()
{
	...
	d3dDepthStencilDesc.DepthEnable = TRUE;	// 깊이 검사 on/off
