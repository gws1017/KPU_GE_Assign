...
void MoveChar(double time, XMVECTOR& destinationDirection, XMMATRIX& worldMatrix)
{
	...
	printf("direction : %f %f %f\n", XMVectorGetX(destinationDirection), XMVectorGetY(destinationDirection), XMVectorGetZ(destinationDirection));
	...
	float destDirLength = 50.0f * frameTime;		// Change to the speed you want your character to rotate. This uses the game timer from an earlier lesson
	...
	float charDirAngle = XMVectorGetX(XMVector3AngleBetweenNormals(
		XMVector3Normalize(currCharDirection), XMVector3Normalize(DefaultForward)));
	...
	printf("radian : %f\n", charDirAngle);
	printf("olddirection : %f %f %f\n", XMVectorGetX(oldCharDirection), XMVectorGetY(oldCharDirection), XMVectorGetZ(oldCharDirection));
