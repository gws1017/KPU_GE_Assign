...
{
	return(CShader::CompileShaderFromFile((WCHAR*)L"Shaders.hlsl", "VSLighting", "vs_5_1",
		ppd3dShaderBlob));
}
D3D12_SHADER_BYTECODE CObjectsShader::CreatePixelShader(ID3DBlob** ppd3dShaderBlob)
{
	return(CShader::CompileShaderFromFile((WCHAR*)L"Shaders.hlsl", "PSLighting", "ps_5_1",
		ppd3dShaderBlob));
}
